  ...
  <nav class="bg-white shadow-lg relative z-10">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
      ...
      <div class="hidden md:flex gap-6 font-roboto items-center">
        ...
        <!-- Mega Menu Wrapper -->
        <div class="group">
          <a href="#" class="text-t-second hover:text-c-main text-[16px] font-normal transition flex items-center gap-1">
            Career
            <i class="fa-solid fa-chevron-down text-xs"></i>
          </a>
          <!-- Mega Menu Panel -->
          <div class="absolute left-0 top-[60px] w-full bg-white shadow-lg rounded-xl mt-4 p-6 opacity-0 group-hover:opacity-100 invisible group-hover:visible transition-all duration-200">
            ...
            <div class="container mx-auto flex" x-data="{ tab: 'digital' }">
              ...
              <div class="w-64 pr-6 border-r">
                <ul class="flex flex-col gap-2">
                  <li>
                    <button @click="tab = 'digital'" :class="tab === 'digital' ? 'text-c-main bg-orange-50 font-semibold' : 'text-t-second hover:text-c-main'" class="rounded p-2 block w-full text-left transition">Digital Marketing</button>
                  </li>
                  <li>
                    <button @click="tab = 'it'" :class="tab === 'it' ? 'text-c-main bg-orange-50 font-semibold' : 'text-t-second hover:text-c-main'" class="rounded p-2 block w-full text-left transition">IT</button>
                  </li>
                </ul>
              </div>
              <!-- Services Grid -->
  ...
  <footer class="bg-black pt-16 pb-8 px-6 md:px-24 border-t border-[#232323]">
    <div class="container mx-auto grid grid-cols-1 md:grid-cols-5 gap-12 py-8 text-sm">
      ...
      <div>
        ...
        <ul class="space-y-3">
          <li><a href="#" class="text-t-white text-[18px] font-roboto font-normal hover:text-c-main pb-1 hover:border-b-2 hover:border-c-main">Home</a>
          </li>
          <li><a href="#" class="text-t-white text-[18px] font-roboto font-normal hover:text-c-main pb-1 hover:border-b-2 hover:border-c-main">Career
              paths</a></li>
          <li><a href="#" class="text-t-white text-[18px] font-roboto font-normal hover:text-c-main pb-1 hover:border-b-2 hover:border-c-main">Case
              studies</a></li>
        </ul>
      </div>
      <!-- Connect -->
      <div>
        ...
        <ul class="space-y-3">
          <li><a href="#" class="text-t-white text-[18px] font-roboto font-normal hover:text-c-main pb-1 hover:border-b-2 hover:border-c-main">Contact</a>
          </li>
          <li><a href="#" class="text-t-white text-[18px] font-roboto font-normal hover:text-c-main pb-1 hover:border-b-2 hover:border-c-main">Privacy
              Policy</a></li>
          <li><a href="#" class="text-t-white text-[18px] font-roboto font-normal hover:text-c-main pb-1 hover:border-b-2 hover:border-c-main">Terms
              of service</a></li>
          <li><a href="#" class="text-t-white text-[18px] font-roboto font-normal hover:text-c-main pb-1 hover:border-b-2 hover:border-c-main">Sitemap</a>
          </li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul class="space-y-3 mt-4">
          <li><a href="#" class="text-t-white text-[18px] font-roboto font-normal hover:text-c-main pb-1 hover:border-b-2 hover:border-c-main">Blog</a>
          </li>
          <li><a href="#" class="text-t-white text-[18px] font-roboto font-normal hover:text-c-main pb-1 hover:border-b-2 hover:border-c-main">Meet
              Rohit Rajput</a></li>
        </ul>
      </div>
    </div>
