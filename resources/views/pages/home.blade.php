...
.container-wrapper {
  ...
  gap: 0;
  /* Remove gap to allow proper overlap */
}
</style>
    ...
    <div class="w-full lg:w-1/2 p-4 sm:p-6 md:p-8 lg:p-0 flex flex-col justify-center mr-4">
      ...
      <div class="mx-auto md:mx-0 flex items-center gap-3 sm:gap-4">
        ...
        <div class="flex items-center">
          <span class="m-1 sm:m-2 text-gray-700 font-medium text-sm sm:text-base">4.9</span>
          <div class="flex">
            <!-- Full stars -->
...
<section class="bg-white autoflow">
  <div class="container mx-auto px-4 md:px-0">
    ...
    <div
      ...
      <!-- Service 1 -->
      <div class="bg-c-main rounded-lg overflow-hidden border border-gray-300 flex flex-col">
        ...
        <div class="p-6 pt-0">
          <a href="#" class="text-white hover:underline inline-flex items-center gap-2">
      ...
      <div
        ...
        <!-- Default Content -->
        <div class="p-6 relative z-10 flex-grow group-hover:opacity-0 transition-opacity duration-300">
          <div class="w-14 h-14 bg-c-main text-white rounded-full flex items-center justify-center mb-8">
        ...
        <div class="p-6 pt-0 relative z-10 group-hover:opacity-0 transition-opacity duration-300">
          <a href="#" class="text-gray-600 hover:underline inline-flex items-center gap-2">
            Meet Rohit <i class="fa-solid fa-arrow-right"></i>
          </a>
        </div>

        <!-- Hover Overlay -->
        <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col">
          <div class="flex-grow relative overflow-hidden">
            <img src="{{ asset('assets/meetRohit.png') }}" alt="Rohit Rajput"
...
<section class="bg-c-main autoflow">
  <div class="container mx-auto py-8 sm:py-10 md:py-12 lg:py-16 xl:py-20 2xl:py-24">
    <div class="flex flex-col lg:w-[60%] items-center text-center gap-4 sm:gap-6 max-w-4xl mx-auto px-4">
      <!-- Title -->
      <h2 class="font-poppins font-bold text-[48px] leading-[100%] tracking-[-0.02em] text-white text-center">
        Get Your Free Roadmap
      </h2>

      <!-- Description -->
      <p class="font-roboto font-light text-[20px] leading-[30px] tracking-[0.02em] text-white text-center max-w-prose">
      ...
      <div class="flex gap-4 mt-4 w-full sm:w-[80%]">
        ...
        <label for="consent" class="text-sm text-white font-light text-left">
    ...
    <div class="flex flex-col lg:flex-row gap-4 md:gap-6 p-4 md:p-0 autoflow">
      ...
      <div class="bg-[#a6aef2] rounded-xl overflow-hidden flex flex-col w-full lg:w-[488px] lg:h-[635px]">
        ...
        <div class="w-full aspect-[488/300] lg:h-[420px] overflow-hidden">
          <img src="{{ asset('assets/graphics/one.png') }}" alt="Case study illustration"
            class="w-full h-full object-cover" loading="lazy" decoding="async" width="488" height="300" />
        </div>
      ...
      <div class="flex flex-col gap-6 w-full lg:w-[712px]">
        ...
        <div class="bg-[#fdd8ce] rounded-xl overflow-hidden flex flex-col md:flex-row w-full h-auto md:h-[247px]">
          ...
          <div class="w-full md:w-1/2 aspect-[356/247] md:h-full">
            <img src="{{ asset('assets/graphics/three.png') }}" alt="E-commerce growth chart"
              class="w-full h-full object-cover" loading="lazy" decoding="async" width="356" height="247" />
          </div>
        </div>
        ...
        <div class="flex flex-col sm:flex-row gap-6 w-full">
          <!-- Left Card -->
          <div
            class="bg-[#d0edfb] rounded-xl overflow-hidden flex flex-col w-full sm:w-1/2 lg:w-[347px] h-auto sm:h-[367px]">
            <!-- Text -->
            ...
            <div class="w-full mt-4 aspect-[347/183.5] sm:h-1/2">
              <img src="{{ asset('assets/graphics/four.png') }}" alt="Content strategy results"
                class="w-full h-full object-cover object-top" loading="lazy" decoding="async" width="347"
                height="183.5" />
            </div>
          </div>
          ...
          <!-- Right Card -->
          <div
            class="bg-[#d1fae5] rounded-xl overflow-hidden flex flex-col w-full sm:w-1/2 lg:w-[347px] h-auto sm:h-[367px]">
            <!-- Image -->
            <div class="w-full aspect-[347/183.5] sm:h-1/2">
              <img src="{{ asset('assets/graphics/two.png') }}" alt="SEO optimization"
                class="w-full h-full object-cover" loading="lazy" decoding="async" width="347" height="183.5" />
            </div>
            <!-- Text -->
